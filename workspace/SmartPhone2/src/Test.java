...
public class Test {
	...
	public static void main(String[] args) {
	  ...
	  SmartPhone iphone2=new SmartPhone("iphone2",50000);
	  System.out.println(iphone2.name);
	  System.out.println(iphone2.price);

	  SmartPhone iphone3=new SmartPhone(50000);
	  System.out.println(iphone3.price);

	  SmartPhone iphone4=new SmartPhone(5000,"iphone4");
